...
class DataIngestion:
    ...
    def download_data(self) -> str:
        ...
        try:
            ...
            zip_file_path = os.path.join(
                zip_download_dir, self.data_ingestion_config.s3_data_name
            )
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        logging.info(
            "Inside initiate_data_ingestion method of \
        ...
        try:
            ...
            logging.info(
                "Completed executing initiate_data_ingestion method of \
                         src.object_detection.components.Data_Ingestion class"
            )
